...
if (! function_exists('saaslauncher_styles')) :
	function saaslauncher_styles()
	{
		...
		// Custom Roblox styles
		wp_add_inline_style('saaslauncher-style', '
			/* Gaming color palette */
			:root {
			  --roblox-primary: #00b4d8;
			  --roblox-secondary: #ff6b35;
			  --roblox-dark: #0a0e27;
			  --roblox-light: #f8f9fa;
			  --roblox-accent: #7209b7;
			}
			
			/* Header customization */
			.site-header {
			  background: linear-gradient(135deg, var(--roblox-dark) 0%, #1a1f3a 100%);
			  border-bottom: 3px solid var(--roblox-primary);
			}
			...
			.wp-block-post-terms a {
			  background: linear-gradient(45deg, var(--roblox-primary), var(--roblox-accent));
			...
			.wp-block-post-terms a:hover {
			  background: linear-gradient(45deg, var(--roblox-secondary), var(--roblox-accent));
			  transform: scale(1.05);
			}
			
			/* Post titles */
			.wp-block-post-title a {
			  color: var(--roblox-dark) !important;
			  font-weight: 700;
			  line-height: 1.3;
