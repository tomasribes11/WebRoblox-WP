 ...
 */
?>
<!-- wp:cover {"align":"full","isUserOverlayColor":true,"minHeight":100,"gradient":"gradient-one","metadata":{"categories":["saaslauncher"],"patternName":"saaslauncher/header-minimal","name":"Header Minimal Light"},"className":"is-style-saaslauncher-cover-unset-overflow","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained","contentSize":"100%"}} -->
<div class="wp-block-cover alignfull is-style-saaslauncher-cover-unset-overflow" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;min-height:100px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim has-background-gradient has-gradient-one-gradient-background"></span>
